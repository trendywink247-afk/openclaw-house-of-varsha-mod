...
export default function Footer() {
  ...
  return (
    <footer className="bg-cream py-8 mt-20 border-t border-gray-200 text-center font-sans text-sm text-taupe">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/shop" className="text-taupe hover:text-dark-taupe transition-colors">
                  Shop
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-taupe hover:text-dark-taupe transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-taupe hover:text-dark-taupe transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  ...
                  className="text-taupe hover:text-dark-taupe transition-colors flex items-center gap-2"
                >
